...
import os
import copy
from se_model import Edge_Detector,Res_Block,UResNet_SE
import argparse
from dataloader import TrainDataSet

def train(config):
	device = torch.device("cuda:" + str(config.cuda_id))
	model = UResNet_SE().to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--snapshots_folder', type=str, default="./snapshots/ensemble_se/")
