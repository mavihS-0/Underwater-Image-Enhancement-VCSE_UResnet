...
import os
import copy
from sobel_model import Edge_Detector,Res_Block,UResNet_Sobel
import argparse
from dataloader import TrainDataSet

def train(config):
	device = torch.device("cuda:" + str(config.cuda_id))
	model = UResNet_Sobel().to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--snapshots_folder', type=str, default="./snapshots/sobel_new/")
